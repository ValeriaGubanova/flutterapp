...
Widget TariffsAndLimits() {
  ...
  Container(
  constraints: BoxConstraints(maxWidth: 200), // Устанавливаем максимальную ширину текста
  child: Text(
  'Информация о тарифах и лимитах',
  style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.bold),
  textAlign: TextAlign.left,
  maxLines: 2, // Устанавливаем максимальное количество строк
  overflow: TextOverflow.ellipsis, //  Текст обрезается с многоточием, если не умещается
  ),
  ),
        SizedBox(width: 85),
